...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/viewer.css') }}"/>
    <link rel="stylesheet" href="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdf-flip.css') }}"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url('{{ asset('adminlte/bower_components/pdf-flipbook-master/pics/loader.gif') }}') center no-repeat #fff;
        }
    </style>
</head>
...
<script type="text/javascript">
    ...
    //var PDFJS.workerSrc = '{{ asset("adminlte/bower_components/pdf-flipbook-master/pdfjs/build/pdf.worker.js") }}';
</script>
<!-- outerContainer -->
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/compatibility.js') }}"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/locale/locale.properties') }}"/>
<script src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/turnjs/turn.min.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/turnjs/zoom.min.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/l10n.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/build/pdf.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/debugger.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdfjs/viewer.js') }}"></script>
<script src="{{ asset('adminlte/bower_components/pdf-flipbook-master/pdf-flip.js?v=1.1.1.1.1.1') }}"></script>
<script type="text/javascript">
