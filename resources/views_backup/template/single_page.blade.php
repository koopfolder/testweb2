...
@php
    //dd("Single Page");
@endphp
@if(method_exists('App\Modules\SinglePage\Http\Controllers\FrontController', 'getData'))   
    @php
    //dd($menu);
        $data = App\Modules\SinglePage\Http\Controllers\FrontController::getData($menu);
        //dd($data);
    @endphp
@endif
