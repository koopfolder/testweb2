...
@php
	$lang = \App::getLocale();
@endphp
@if(method_exists('App\Modules\Api\Http\Controllers\FrontendController', 'getDataMedia'))   
    @php
        $data = App\Modules\Api\Http\Controllers\FrontendController::getDataMedia($request->all());  
        //dd($data['items']->total());
                    ...
                    <div class="box_search">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <script async src="https://cse.google.com/cse.js?cx=006284558000193077559:0vdsttwcr3i"></script>
                ...
                @if($data['items']->total())
                    @foreach($data['items'] AS $key=>$value)
                        ...
                        <div class="col-xs-12 col-sm-4 item_learning">
                            <a href="{{ $value->url }}">
                                <figure>
                                    <img data-src="{{ $value->cover_desktop }}"  src="{{ asset('themes/thrc/images/Placeholder.png') }}" alt="{{ $value->title }}" class="img-responsive"><div class="lmicon {{ $icon }}"></div>
                                </figure>
                                <figcaption>
