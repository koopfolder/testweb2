...
@php
    ...
    //dd("asdasdsasd");
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\IncludeStatisticsController', 'getDataIncludeStatistics'))   
    @php
        $data = App\Modules\Article\Http\Controllers\IncludeStatisticsController::getDataIncludeStatistics($request->all());  
        //dd($data,$request->all());
    @endphp
@endif
@extends('layouts.app')
