...
@php
	//dd("Test");
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\ThaihealthWatchController', 'getDataThaihealthWatchPointsToWatchVideo')) 
    @php
        $data = App\Modules\Article\Http\Controllers\ThaihealthWatchController::getDataThaihealthWatchPointsToWatchVideo($request->all());  
        //dd($data,$request->all());
    @endphp
@endif
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 head_inside2">
                    <h1>ประเด็นที่น่าจับตา วิดีโอ</h1>
                </div>
            </div>
            <div class="row">
