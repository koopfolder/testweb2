                ...
                @if($data['items']->count())
                    @foreach($data['items'] AS $key=>$value)
                        ...
                        <div class="col-xs-12 col-sm-4 item_learning">
                              <!-- <a href="{{ $value->url }}>"-->
                             <a href="{{route('article-ncds6-detail',['slug'=>$value->slug])}}" target="_blank">
                                <figure>
...
@section('meta')
    @parent
    <title>แบบทดสอบทักษะความรอบรู้ด้านสุขภาพ</title>
    <meta charset="UTF-8">
    <meta name="description" content="แบบทดสอบทักษะความรอบรู้ด้านสุขภาพ">
    <meta name="keywords" content="แบบทดสอบทักษะความรอบรู้ด้านสุขภาพ">
