...
@php
	//dd("Test");
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\LearningAreaCreatesDirectExperienceController', 'getDataLearningAreaCreatesDirectExperience')) 
    @php
        $data = App\Modules\Article\Http\Controllers\LearningAreaCreatesDirectExperienceController::getDataLearningAreaCreatesDirectExperience($request->all());  
        //dd($data,$request->all());
    @endphp
@endif
@extends('layouts.app')
                    ...
                    @if($data['items']->count())
                        @foreach($data['items'] AS $key=>$value)
                            @php
                                //dd($menu);
                                //dd($value);
                                $value->url = route('learning-area-creates-direct-experience-detail',$value->slug);
...
@section('meta')
    @parent
    <title>พื้นที่เรียนรู้สร้างประสบการณ์ตรง</title>
    <meta charset="UTF-8">
    <meta name="description" content="พื้นที่เรียนรู้สร้างประสบการณ์ตรง">
    <meta name="keywords" content="พื้นที่เรียนรู้สร้างประสบการณ์ตรง">
