...
@php
	$lang = \App::getLocale();
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\SooklibraryController', 'getDataSooklibrary'))   
    @php
        $data = App\Modules\Article\Http\Controllers\SooklibraryController::getDataSooklibrary($request->all());  
        //dd($data['items']->count());
    @endphp
@endif
@extends('layouts.app')
