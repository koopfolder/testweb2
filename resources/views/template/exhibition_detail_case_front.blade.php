        ...
        <div class="container">
            <div class="row row_content">
                <div class="col-xs-12 col-sm-8 left_content">
                    ...
                    @endif
                    <img src="http://thrc.hap.com/calendar.jpg" style="margin: 95px;">
                    <br>
                    <div class="row row_learning row_sp_list" style="display: block;">

                                                                            
                        <div class="col-xs-12 item_learning" style="border-bottom: 1px solid #ddd;">
                            <a href="http://thrc.hap.com/article/test-23">
                                <div class="col-xs-2">
                                    <figure style="margin-top:20px;">
                                        Route1
                                    </figure>
                                </div>
                                <div class="col-xs-10" style="border-left: 1px solid #c6c7c7;">
                                <figcaption>
                                    <h1 class="dotmaster" style="overflow-wrap: break-word;"></h1>
                                        <p class="dotmaster" style="overflow-wrap: break-word;">
                                        <button class="button button-showtime active" style="margin: 8px;">Round:09:30 | Avilable:16 </button>
                                        <button class="button button-showtime active" style="margin: 8px;">Round:10:30 | Avilable:16 </button> 
                                        <button class="button button-showtime active" style="margin: 8px;">Round:11:30 | Avilable:16 </button> 
                                        <button class="button button-showtime active" style="margin: 8px;">Round:13:30 | Avilable:16 </button>
                                        </p>
                                </figcaption>
                                </div> 
                            </a>
                        ...
                        <div class="col-xs-12 item_learning" style="border-bottom: 1px solid #ddd;">
                            <a href="http://thrc.hap.com/article/test-23">
                                ...
                                <figcaption>
                                    <h1 class="dotmaster" style="overflow-wrap: break-word;"></h1>
                                        <p class="dotmaster" style="overflow-wrap: break-word;">
                                        <button class="button button-showtime active" style="margin: 8px;">Avilable:16 | Round:09:30</button>
                                        <button class="button button-showtime active" style="margin: 8px;">Avilable:16 | Round:10:30</button> 
                                        <button class="button button-showtime active" style="margin: 8px;">Avilable:16 | Round:11:30</button> 
                                        <button class="button button-showtime active" style="margin: 8px;">Avilable:16 | Round:13:30</button>
                                        </p>
                                </figcaption>
                                </div>
                            </a>
