...
@php
    ...
    //dd($menu);
@endphp
@if(method_exists('App\Modules\Exhibition\Http\Controllers\FrontendController', 'getDataListExhibitionCaseClosedToVisitors'))   
    @php
        $data = App\Modules\Exhibition\Http\Controllers\FrontendController::getDataListExhibitionCaseClosedToVisitors($menu);  
...
<section class="row wow fadeInDown">
        <div class="container">
            ...
            @if($data['items_is_closed_to_visitors']->count() == 0)
