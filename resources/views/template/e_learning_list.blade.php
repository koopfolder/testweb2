...
@php
	$lang = \App::getLocale();
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\ElearningController', 'getDataElearing'))   
    @php
        $data = App\Modules\Article\Http\Controllers\ElearningController::getDataElearing($request->all());  
        //dd($data['items']->count());
    @endphp
@endif
@extends('layouts.app')
