...
@php
    ...
    //dd("asdassds");
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\HealthLiteracyController', 'getDataHealthLiteracy2'))   
    @php
        $data = App\Modules\Article\Http\Controllers\HealthLiteracyController::getDataHealthLiteracy2($request->all(),$category_id);  
       //dd($data['items']);
    @endphp
@endif
@extends('layouts.app')
@section('content')
@include('partials.search_health_literacy2')
