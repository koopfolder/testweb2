...
@php
	$lang = \App::getLocale();
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\OurserviceController', 'getDataOurservice'))   
    @php
        $data = App\Modules\Article\Http\Controllers\OurserviceController::getDataOurservice($request->all());  
        //dd($data['items']->count());
    @endphp
@endif
@extends('layouts.app')
