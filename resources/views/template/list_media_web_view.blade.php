  ...
  <div class="modal-dialog modalCenter">
    <div class="modal-content">
      ...
      <div class="modal-header" style="text-align:center;">
        <!--<h4 class="modal-title">ท่านจะทำแบบสำรวจความพึงพอใจตอนนี้ใช่หรือไม่</h4>-->
		<img src="https://persona.thaihealth.or.th/banner/media-satisfaction-assessment.png" width="250px">
      </div>

      <!-- Modal body -->
      <div class="modal-body">
		<div class="d-flex justify-content-center" style="text-align:center;">
			<a href="https://persona.thaihealth.or.th/assessment?client_app=thaihealth&redirect={{url()->current()}}" class="btn btn-success btn-lg btnFull" value="1">
				เริ่มทำแบบประเมิน
			</a><br>
			<a onClick="closeModal()" class="btn btn-danger btn-lg btnFull" value="2">
				ยังไม่ทำในตอนนี้
			</a>
		</div>
      </div>
