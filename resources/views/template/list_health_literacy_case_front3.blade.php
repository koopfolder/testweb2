...
@php
    ...
    //dd("asdassds");
@endphp
@if(method_exists('App\Modules\Article\Http\Controllers\HealthLiteracyController', 'getDataHealthLiteracy3'))   
    @php
        $data = App\Modules\Article\Http\Controllers\HealthLiteracyController::getDataHealthLiteracy3($request->all());  
       //dd($data['items']);
    @endphp
@endif
@extends('layouts.app')
