            ...
            <div class="row row_content">
                <div class="col-xs-12">
                    <div class="head_inside">
                        <h1>จองนิทรรศการ @if(isset($data->title)) {{ $data->title }} @endif</h1>
                    </div>
                    <div class="box_formregister">
                        {!! Form::open(['url' => route('book-an-exhibition.create'),'method'=>'post','id'=>'requestmediaForm']) !!}
                          <div class="row">
                              ...
                              <div class="col-xs-12 col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" style="margin: 0px 3px 0px 0px; height: 198px; width: 1076px;"></textarea>
                                  </div>
                              </div>
                              <div class="col-xs-12">
                          ...
                          <input type="hidden" name="exhibition_id" value="{{ $data->id }}" >
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
