...
<head>
  ...
  <![endif]-->
    ...
    <script type="text/javascript" language="javascript"
        src="{{ asset('themes/thrc/dotdotdot-master/src/js/jquery.dotdotdot.min.js') }}"></script>

    <!-- Add mousewheel plugin (this is optional) -->
    <script type="text/javascript" src="{{ asset('themes/thrc/fancybox/lib/jquery.mousewheel-3.0.6.pack.js') }}"></script>
    <!-- Add fancyBox main JS and CSS files -->
    <script type="text/javascript" src="{{ asset('themes/thrc/fancybox/source/jquery.fancybox.min.js?v=2.1.5') }}">
    </script>
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/thrc/fancybox/source/jquery.fancybox.css?v=2.1.5') }}" media="screen" />
    <!-- Add Button helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/thrc/fancybox/source/helpers/jquery.fancybox-buttons.css?v=1.0.5') }}" />
    <script type="text/javascript"
        src="{{ asset('themes/thrc/fancybox/source/helpers/jquery.fancybox-buttons.min.js?v=1.0.5') }}"></script>
    <!-- Add Thumbnail helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/thrc/fancybox/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7') }}" />
    <script type="text/javascript"
        src="{{ asset('themes/thrc/fancybox/source/helpers/jquery.fancybox-thumbs.min.js?v=1.0.7') }}"></script>
    <!-- Add Media helper (this is optional) -->
    <script type="text/javascript"
        src="{{ asset('themes/thrc/fancybox/source/helpers/jquery.fancybox-media.min.js?v=1.0.6') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('themes/thrc/flexslider/flexslider.css') }}" type="text/css"
        media="screen" />
    <!-- Modernizr -->
    ...
    <script
        src="{{ asset('adminlte/bower_components/jQuery-Plugin-To-Smartly-Load-Images-While-Scrolling-loadScroll/jQuery.loadScroll.min.js') }}">
    </script>
    ...
    <!-- connect x -->
    <script src="{{ asset('js\connectxlogs.js') }}"></script>
    <script defer type="text/javascript" id="connectxWebTracking"
        src="https://tracking.connect-x.tech/connectx/api/webTrackingSdk.min.js?orgId=sT7oVQc4gutP3hghRo4P"></script>
    ...
    {{-- <meta http-equiv="Content-Security-Policy" content="script-src 'self'; style-src 'self'; link-src 'self';"> --}}
    <meta http-equiv="Content-Security-Policy"
        content="default-src * 'unsafe-inline' 'unsafe-eval'; script-src * 'unsafe-inline' 'unsafe-eval'; style-src * 'unsafe-inline'; img-src * data:; font-src * data:;">
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-W8WPDZW');
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W8WPDZW" height="0" width="0"
    ...
    <div id="float-consent" style="display:none;">
        <div class="float-consent-sub">
            ...
            <a href="{{ env('URL_PDPA_POLICY', 'https://pdpa.thaihealth.or.th/content/policy') }}"
