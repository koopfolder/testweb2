        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-9 col-md-10 wrap_searchinside">
                    {{ Form::open(['url' =>route('list-health-literacy3'),'method' =>'get','id'=>'form_search']) }}
                    <div class="searchbox_inside">
                            ...
                            <div class="selectbox">
                                <select name="issue">
                                    ...
                                    <option value="61" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '61' ? 'selected':''):'') }} >มลภาวะทางอากาศ</option>
                                    <!--<option value="55" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '55' ? 'selected':''):'') }} >ยาสูบ</option>
                                    <option value="56" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '56' ? 'selected':''):'') }} >เหล้า</option>-->
                                    <option value="58" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '58' ? 'selected':''):'') }} >โรคปอดอุดกั้นเรื้อรัง</option>
                                    <option value="57" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '57' ? 'selected':''):'') }} >โรคมะเร็ง</option>
                                    <option value="59" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '59' ? 'selected':''):'') }} >โรคหัวใจและหลอดเลือด</option>
                                    <option value="60" {{ (isset($data['old']['issue']) ? ($data['old']['issue'] == '60' ? 'selected':''):'') }} >โรคเบาหวาน</option>
