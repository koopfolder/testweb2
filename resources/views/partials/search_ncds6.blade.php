...
@php
    $age =ThrcHelpers::getAge($request->all());
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-2 head_avsearch">
                    <h1><span>เครื่องมืออื่่นๆ</span><span>ที่่น่าสนใจ</span></h1>
                </div>
                <div class="col-xs-12 col-sm-9 col-md-10 wrap_searchinside">
                    {{ Form::open(['url' => route('article-other-interesting-tools'),'method' =>'get','id'=>'form_search']) }}
