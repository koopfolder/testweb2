            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::radio('knowledges', '2', ($settings['knowledges'] == $data->id ? true:false)) }}{{ trans('api::backend.yes') }}
                        {{ Form::radio('knowledges', '1', ($settings['knowledges'] != $data->id ? true:false)) }}{{ trans('api::backend.no') }}
                    </div>
                    <div class="form-group">
                        <label for="InputName">{{ trans('api::backend.media_campaign') }} </label>
                        {{ Form::radio('media_campaign', '2', ($settings['media_campaign'] == $data->id ? true:false)) }}{{ trans('api::backend.yes') }}
                        {{ Form::radio('media_campaign', '1', ($settings['media_campaign'] != $data->id ? true:false)) }}{{ trans('api::backend.no') }}
                    </div>
