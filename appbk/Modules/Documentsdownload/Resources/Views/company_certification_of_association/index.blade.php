...
<section class="content-header">
	<h1>{{ trans('documentsdownload::backend.company_certification_of_association') }}</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.documents-download.company-certification-of-association.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.documents-download.company-certification-of-association.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									@endif
									<a href="{{ route('admin.documents-download.company-certification-of-association.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('documentsdownload::backend.edit') }}
									</a>
									<a href="{{ route('admin.documents-download.company-certification-of-association.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
