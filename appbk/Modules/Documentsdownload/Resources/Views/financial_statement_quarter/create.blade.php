...
<section class="content-header">
    <h1>{{ trans('documentsdownload::backend.add_financial_statement_quarter') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.documents-download.financial-statement-quarter.create'), 'files' => true]) }}
