...
class CompanycertificationofassociationController extends Controller
{
    public function getIndex()
    {
        $items = Documents::Data(['status'=>['publish','draft'],'document_type'=>'company_certification_of_association']);
        return view('documentsdownload::company_certification_of_association.index', compact('items'));
    }

    public function getCreate()
    {
        return view('documentsdownload::company_certification_of_association.create');
    }

    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        $data['document_type'] = 'company_certification_of_association';
        ...
        return redirect()->route('admin.documents-download.company-certification-of-association.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        return view('documentsdownload::company_certification_of_association.edit', compact('data'));
    }
