...
<section class="content-header">
    <h1>{{ trans('sustainability::backend.add_corporate_governance_policy') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i>{{ trans('sustainability::backend.home') }}</a></li>
        <li><a href="{{ route('admin.history.index') }}">{{ trans('sustainability::backend.corporate_governance_policy') }}</a></li>
        <li class="active">{{ trans('sustainability::backend.add') }}</li>
    </ol>
</section>
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.sustainability.corporate-gov-policy.create'), 'files' => true]) }}
