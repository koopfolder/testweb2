...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.room.category.create'), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('use_room_detail', $rooms, old('use_room_detail'), ['class' => 'form-control']) !!}
                    </div>
                </div>
            </div>
        </div>
