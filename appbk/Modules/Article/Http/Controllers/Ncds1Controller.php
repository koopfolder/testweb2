...
class Ncds1Controller extends Controller
{
    ...
    {
        //dd("ncds-1");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'ncds-1']);
        //dd($items);
        return view('article::backend.ncds-1.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'ncds-1']);
    ...
    public function getCreate()
    {
        ...
        return view('article::backend.ncds-1.create',compact('tags','categorys'));
    ...
    public function postCreate(CreateRequest $request)
    {
        ...
        self::postLogs(['event'=>'เพิ่มข้อมูลหัวข้อ "'.$data['title'].'"','module_id'=>'36']);
        return redirect()->route('admin.ncds-1.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        return view('article::backend.ncds-1.edit', compact('data','revisions','tags','tags_select','categorys'));
    }
    ...
    public function postEdit(EditRequest $request, $id)
    {
        ...
        self::postLogs(['event'=>'แก้ไขข้อมูลหัวข้อ "'.$data['title'].'"','module_id'=>'36']);
        return redirect()->route('admin.ncds-1.index')
                            ->with('status', 'success')
