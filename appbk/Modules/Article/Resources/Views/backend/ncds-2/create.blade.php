...
<section class="content-header">
    <h1>{{ trans('article::backend.add_ncds-2') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i>{{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.ncds-2.index') }}">{{ trans('article::backend.ncds-2') }}</a></li>
        <li class="active">{{ trans('article::backend.add') }}</li>
    </ol>
</section>
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.ncds-2.create'), 'files' => true]) }}
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <br>
                        {{ Form::radio('situation_ncds', '1', true) }}{{ trans('article::backend.general_situation') }}
                        {{ Form::radio('situation_ncds', '2', false) }}{{ trans('article::backend.disease_situation') }}
                    </div>
                    <!--<div class="form-group">
                        <label>{{ trans('article::backend.category') }}</label>
                        {!! Form::select('category_id',$categorys,old('category_id'), ['class' => 'form-control js-tags-tokenizer']) !!}
                    </div>-->
