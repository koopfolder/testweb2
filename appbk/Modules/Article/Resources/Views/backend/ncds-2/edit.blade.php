...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_ncds-2') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.article.index') }}">{{ trans('article::backend.ncds-2') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.ncds-2.edit', $data->id), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.ncds-2.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
            ...
            <div class="box box-warning">
                ...
                @php
                    if($data->dol_json_data !=''){
                        ...
                        //dd($json_data);
                        if(!isset($json_data->situation_ncds)){
                            $json_data->situation_ncds = 1;
                        }
                    }else{
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="InputName">{{ trans('article::backend.situation_ncds') }}</label>
                        <br>
                        {{ Form::radio('situation_ncds', '1', ($json_data->situation_ncds == '1' ? true:false)) }}{{ trans('article::backend.general_situation') }}
                        {{ Form::radio('situation_ncds', '2', ($json_data->situation_ncds == '2' ? true:false)) }}{{ trans('article::backend.disease_situation') }}
                    </div>
                    <!--<div class="form-group">
