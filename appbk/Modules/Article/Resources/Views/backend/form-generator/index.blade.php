...
<section class="content-header">
	<h1>{{ trans('article::backend.form-generator') }}</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.thaihealth-watch.form-generator.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.thaihealth-watch.form-generator.create') }}" class="btn btn-primary">
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									<a href="{{ route('admin.thaihealth-watch.form-generator.report',$item->id) }}" class="btn btn-success" target="_blank">
										<i class="fa fa-table"></i> {{ trans('article::backend.form-generator-report') }}
									</a>
									<a href="{{ route('admin.thaihealth-watch.form-generator.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('article::backend.edit') }}
									</a>
									@if($item->status !='publish')
									<a href="{{ route('admin.thaihealth-watch.form-generator.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
