...
<section class="content-header">
    <h1>{{ trans('article::backend.add_form-generator') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.thaihealth-watch.form-generator.create'), 'files' => true]) }}
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_description">
                                ...
                                <label for="InputName">{{ trans('article::backend.form-generator') }} <span style="color:red">*</span></label>
                                    ...
                                    <textarea name="form-generator-data" id="form-generator-data" style="display:none"></textarea>
