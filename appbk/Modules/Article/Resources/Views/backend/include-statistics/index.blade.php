...
<section class="content-header">
	<h1>{{ trans('article::backend.include-statistics') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.include-statistics.index') }}">{{ trans('article::backend.include-statistics') }}</a></li>
	</ol>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.include-statistics.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.include-statistics.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									<a href="{{ route('admin.include-statistics.edit', $item->id) }}" class="btn btn-primary">
