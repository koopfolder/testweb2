...
<section class="content-header">
    <h1>{{ trans('article::backend.add_panel-discussion') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.thaihealth-watch.panel-discussion.create'), 'files' => true]) }}
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('year',$years,old('year'), ['class' => 'form-control']) !!}
                    </div>                     
                    <div class="form-group">
