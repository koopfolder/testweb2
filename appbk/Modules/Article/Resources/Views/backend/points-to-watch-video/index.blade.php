...
<section class="content-header">
	<h1>{{ trans('article::backend.points-to-watch-video') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.thaihealth-watch.points-to-watch-video.index') }}">{{ trans('article::backend.points-to-watch-video') }}</a></li>
	</ol>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.thaihealth-watch.points-to-watch-video.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.thaihealth-watch.points-to-watch-video.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									<a href="{{ route('admin.thaihealth-watch.points-to-watch-video.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('article::backend.edit') }}
									</a>
									@if($item->status !='publish')
									<a href="{{ route('admin.thaihealth-watch.points-to-watch-video.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
