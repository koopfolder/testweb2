...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_health-literacy') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.health-literacy.edit', $data->id), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.health-literacy.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        @endphp
                        <label>{{ trans('article::backend.health-literacy-category2') }} <span style="color:red">*</span></label>
                        {!! Form::select('category_id[]',$category_id,$data->category_id ?? old('category_id'),['class' => 'form-control','multiple'=>'multiple']) !!}
                    </div>
                    <div class="form-group">
                        @php
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.health-literacy.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
    ...
    function del_document(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.health-literacy.ajaxdeletedocument") }}',
                type: "POST",
                dataType: 'json',
                data: {_token:jQuery('meta[name="csrf-token"]').attr('content'),id:media_id},
                success:function(response){
