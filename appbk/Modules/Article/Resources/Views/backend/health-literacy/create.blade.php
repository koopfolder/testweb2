...
<section class="content-header">
    <h1>{{ trans('article::backend.add_health-literacy') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.health-literacy.create'), 'files' => true]) }}
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id[]',$category_id,old('category_id'),['class' => 'form-control','multiple'=>'multiple']) !!}
                    </div>
                    <div class="form-group">
                        @php
