...
<section class="content-header">
    <h1>{{ trans('article::backend.add_e-learning') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i>{{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.e-learning.index') }}">{{ trans('article::backend.e-learning') }}</a></li>
        <li class="active">{{ trans('article::backend.add') }}</li>
    </ol>
</section>
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.e-learning.create'), 'files' => true]) }}
