...
class ThaiHealthWatchSpeakers extends Model implements HasMediaConversions
{
    use HasMediaTrait;
    protected $table = 'thai_health_watch_speakers';
    ...
    public function scopeData($query,$params)
    {
        ...
        // }
            $query->select('id','name','surname','position','created_at','created_by','updated_by','status');
