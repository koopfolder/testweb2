...
class Article extends Model implements HasMediaConversions
{
    ...
    public function scopeDetail($query,$params){
        $lang = $this->getLang();
        $query->select('id','title','description','hit','created_at','updated_at','status','meta_title','meta_keywords','meta_description','page_layout','dol_url','dol_json_data','dol_UploadFileID','dol_template','category_id','slug','tags','video_path');
