...
<section class="content-header">
	<h1>{{ trans('sustainability::backend.corporate_governance_policy') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('sustainability::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.sustainability.corporate-gov-policy.index') }}">{{ trans('sustainability::backend.corporate_governance_policy') }}</a></li>
	</ol>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.sustainability.corporate-gov-policy.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.sustainability.corporate-gov-policy.create') }}" class="btn btn-primary">
							...
							<a href="{{ route('admin.export.index', ['moduleSlug' => 'sustainability', 'table' => 'article']) }}" class="btn btn-success">
								<i class="fa fa-file-o"></i> {{ trans('sustainability::backend.excel') }}
							</a>
						</div>
					</div>
				</div>
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									<a href="{{ route('admin.sustainability.corporate-gov-policy.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('sustainability::backend.edit') }}
									</a>
									<a href="{{ route('admin.sustainability.corporate-gov-policy.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
