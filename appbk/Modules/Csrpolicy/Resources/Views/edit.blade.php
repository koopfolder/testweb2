...
<section class="content-header">
    <h1>{{ trans('csrpolicy::backend.edit_csrpolicy') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('csrpolicy::backend.home') }}</a></li>
        <li><a href="{{ route('admin.sustainability.corporate-gov-policy.index') }}">{{ trans('csrpolicy::backend.edit_csrpolicy') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.csrpolicy.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('csrpolicy::partials.corporategovpolicy_revision', ['revisions' => $revisions])
                            </div>
                            <a href="{{ route('preview-csr-policy') }}" class="btn btn-success" target="_blank">
