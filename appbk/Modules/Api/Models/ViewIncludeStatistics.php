...
class ViewIncludeStatistics extends Model
{
    protected $table = 'view_include_statistics';
    ...
    public function scopeFrontMain($query,$params){
        ...
        $query->select('id','title','description','json_data','slug','data_type');
    ...
    public function scopeFrontRssFeed($query,$params){
