...
<section class="content-header">
	<h1>{{ trans('exhibition::backend.traveling_exhibition') }}</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.exhibition.traveling.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.exhibition.traveling.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									<a href="{{ route('admin.exhibition.traveling.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('article::backend.edit') }}
									</a>
									@if($item->status !='publish')
									<a href="{{ route('admin.exhibition.traveling.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
