...
<section class="content-header">
    <h1>{{ trans('exhibition::backend.edit_permanent_exhibition') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.exhibition.permanent.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('exhibition::partials.permanent_exhibition.revision', ['revisions' => $revisions])
                            </div>
                            <a href="{{ route('admin.exhibition.permanent.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('exhibition::backend.back') }}</a>
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.exhibition.permanent.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
