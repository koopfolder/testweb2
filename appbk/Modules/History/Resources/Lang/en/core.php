...
/* Core Module */
	...
	"t_tipsdrag"					=> "สามารถสลับตำแหน่งเมนูได้โดยการลาก", // updated apidevlab
	"t_tipsnote"					=> "Note!, Menus only support 3 levels ", // updated apidevlab
	"tab_topmenu"					=> "เมนูหน้าบ้าน",
	"tab_sidemenu"					=> "เมนูหลังบ้าน",
	"sb_reorder"					=> "รีเฟรช เมนู",	
	"fr_mtitle"						=> "ชื่อเมนู ไทย",	
	"fr_mtitle_en"					=> "ชื่อเมนู อังกฤษ ",	
	"fr_mtype"						=> "ประเภท URL",	
	"fr_mposition"					=> "ประเภทเมนู",	
	"fr_mactive"					=> "Active",	
	"fr_minactive"					=> "Inactive",
	"fr_maccess"					=> "การเข้าถึงข้อมูล", // updated apidevlab	
...
/* backend */
	...
	"disabled" => "ไม่เผยแพร่",
	"select_value" => "--เลือก--",
	"select_value_status" => "--สถานะเผยแพร่--",
	...
	"position" =>'ตำแหน่ง',
	"top_menu" =>'เมนูด้านบน',
	"left_menu" =>'เมนูด้านซ้าย',
	"left_menu2" =>'เมนูด้านซ้าย 2',
	"image" => 'รูป',
	"user_group" =>'กลุ่มผู้ใช้',
	"group_name"=>'ชื่อกลุ่ม',
	"description" =>'รายละเอียด',
	"main_group" =>'กลุ่มหลัก',
	"module_permission" =>'การอนุญาตโมดูล',
	"installed_modules" =>'โมดูลที่ถูกติดตั้ง',
	"core_modules" =>'โมดูลหลัก',
	"package_modules" =>'แพ็กเกจโมดูล',
	"type_dropdown_list" =>'ประเภท drop-down list',
	"none" =>'ไม่ระบุ',
	"case_province" =>'ตัวเลือก ทสจ.',
	"case_department" =>'ตัวเลือก สสภ.',
	"case_central" =>'ตัวเลือก ส่วนกลาง',
	"case_department_command" =>'ตัวเลือก กรม ระดับสั่งการ',
	"case_department_action" =>'ตัวเลือก กรม ระดับปฏิบัติการ',
	"database_mnre" =>'ฐานข้อมูล ทส.',
	"note" =>'หมายเหตุ',
		//core menu
	"t_menu"						=> "การจัดการเมนู",
	"t_menusmall"					=> "ของเมนูทั้งหมด",
	"note_pass_word" =>'กรุณาระบุรหัสผ่านอย่างน้อย 6 ตัว และไม่เกิน 12 ตัว',
	"note_create_password" =>'ตั้งรหัสผ่าน',
	"dashboard" => 'การจัดการข้อมูลหลังบ้าน'
