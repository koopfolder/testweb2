...
<section class="content-header">
    <h1>{{ trans('groupstructure::backend.edit_groupstructur') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('groupstructure::backend.home') }}</a></li>
        <li><a href="{{ route('admin.sustainability.corporate-gov-policy.index') }}">{{ trans('groupstructure::backend.groupstructure') }}</a></li>
        <li class="active">{{ trans('groupstructure::backend.edit') }}</li>
    </ol>
</section>

<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.groupstructure.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab_revisions" data-toggle="tab">{{ trans('groupstructure::backend.revisions') }}</a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('groupstructure::partials.corporategovpolicy_revision', ['revisions' => $revisions])
                            </div>
