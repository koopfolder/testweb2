...
namespace App\Modules\Groupstructure\Models;
...
class Article extends Model implements HasMediaConversions
{
    ...
    public function scopeData($query,$params)
    {
        ...
        return $query->whereIn('status',$params['status'])->where('page_layout','=',$params['page_layout'])->with('createdBy','updatedBy')->orderBy('id','desc')->get();
    }
