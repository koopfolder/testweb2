...
<section class="content-header">
    <h1>{{ trans('experienceawards::backend.add_awards') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('sustainability::backend.home') }}</a></li>
        <li><a href="{{ route('admin.experience.awards.index') }}">{{ trans('experienceawards::backend.add_awards') }}</a></li>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('experienceawards::partials.corporategovpolicy_revision', ['revisions' => $revisions])
                            </div>
