...
<section class="content-header">
	<h1>{{ trans('experienceawards::backend.awards') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('experienceawards::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.experience.awards.index') }}">{{ trans('experienceawards::backend.awards') }}</a></li>
	</ol>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.experience.awards.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.experience.awards.create')}}" class="btn btn-primary">
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									<a href="{{ route('admin.experience.awards.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('sustainability::backend.edit') }}
									</a>
									<a href="{{ route('admin.experience.awards.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
