...
class Article extends Model implements HasMediaConversions
{
    ...
    {   
        ...
        // }
            $query->select('id','description_th','description_en','created_at','created_by','updated_by','status');
        return $query->whereIn('status',$params['status'])->where('page_layout','=',$params['page_layout'])->with('createdBy','updatedBy')->first();
    }
    ...
    {   
        $lang = \App::getLocale();
        // if($lang === 'th'){
        //     $query->select('id','description_th AS description');
        // }else{
        //     $query->select('id','description_en AS description');
        // }
        $query->select('id','description_en','description_th');
        return $query
