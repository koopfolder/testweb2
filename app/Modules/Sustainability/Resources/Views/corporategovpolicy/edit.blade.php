...
<section class="content-header">
    <h1>{{ trans('sustainability::backend.edit_corporate_governance_policy') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.sustainability.corporate-gov-policy.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.sustainability.corporate-gov-policy.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('sustainability::backend.back') }}</a>
