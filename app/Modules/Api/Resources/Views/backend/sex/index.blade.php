...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.sex.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.sex.create') }}" class="btn btn-primary">
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									<a href="{{ route('admin.sex.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('api::backend.edit') }}
									</a>
									@if($item->status !='publish')
									<a href="{{ route('admin.sex.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
