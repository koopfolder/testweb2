...
<section class="content-header">
    <h1>{{ trans('api::backend.request_media_detail_edit') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.request-media-detail.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_description">
                                ...
                                <div class="form-group">
                                    <label for="InputName">{{ trans('api::backend.description') }} <span style="color:red">*</span></label>
                                    {{ Form::textarea('description',$data->description ?? old('description'),['class'=>'form-control ckeditor']) }}
                                </div>
                            </div>

                            <a href="{{ route('admin.request-media-detail.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('api::backend.back') }}</a>
