...
Route::group(['prefix' => 'admin', 'middleware' => 'checklogin'], function () {
    ...
    Route::post('api/list-media/QueueDonwloadFileFromDol/{Media_ID}', 'MediaController@QueueDonwloadFileFromDol')->name('QueueDonwloadFileFromDol');
    Route::get('api/list-media/DonwLoadExcelReport', 'MediaController@DonwLoadExcelReport')->name('DonwLoadExcelReport');
    ...
    Route::get('api/list-media/export-excel-api-webview_test', 'MediaController@getExcelReport_test')->name('admin.api.list-media.export-excel-api-webview_test');
    Route::get('api/list-media/DonwLoadExcelReport_test', 'MediaController@DonwLoadExcelReport_test')->name('DonwLoadExcelReport_test');
    ...
    Route::post('/api/list-media/recycletrashall', 'MediaController@recycletrashall')->name('recycletrashall');
    Route::post('/api/list-media/delecttrashall', 'MediaController@delecttrashall')->name('delecttrashall');
    
});
Route::post('taxonomy/add', 'IndexController@taxonomyAdd')->name('taxonomyAdd');
// test ENV
Route::get('test/env', 'IndexController@GET_ENV')->name('GETENV');
Route::get('test/GetMeidaFileFromDol', 'IndexController@GetMeidaFileFromDol')->name('GetMeidaFileFromDol');
Route::get('test/job_user_connect', 'MediaController@job_user_connect')->name('job_user_connect');
Route::get('test/GetPersonaMedia', 'MediaController@GetPersonaMedia')->name('GetPersonaMedia');
Route::get('test/GetMultimediaMp4Thumbnail', 'MediaController@GetMultimediaMp4Thumbnail')->name('GetMultimediaMp4Thumbnail');
Route::get('test/UpdateMediaTermStatusFromExcel', 'IndexController@UpdateMediaTermStatusFromExcel')->name('UpdateMediaTermStatusFromExcel');

Route::get('test/MediaJobFileCheck', 'MediaController@MediaJobFileCheck')->name('MediaJobFileCheck');
Route::get('test/UpdatePersonaFileMedia', 'MediaController@UpdatePersonaFileMedia')->name('UpdatePersonaFileMedia');

Route::get('test/logtest', 'IndexController@logtest')->name('logtest');
// Route::get('GetMeidaFileFromDol', 'IndexController@GetMeidaFileFromDol')->name('GetMeidaFileFromDol');
...
Route::get('api/getphpinfo', 'IndexController@getphpinfo')->name('api.task.media-update.index');
