...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.activities.index') }}">{{ trans('activities::backend.edit_activities') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.activities.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab_gallery" data-toggle="tab">{{ trans('sustainability::backend.gallery') }}</a></li>
                        ...
                        <div class="tab-content">
                                    ...
                                    @if ($data->getMedia('gallery_desktop')->isNotEmpty())
                                        ...
                                        <div class="form-group gallery col-md-6" id="gl_{{ $key+1 }}" data-id="{{ $value->id }}">
                                            ...
                                            <div class="areaImage">
                                                ...
                                                <div><img class="del_gallery" onclick="JavaScript:del_gallery({{ $key+1 }});" src="{{ asset("rooster/images/if_plus_add_minus.png") }}" title="Delete Gallery" id="delete_gallery" alt="delete_gallery"></div>
                                            </div>
                                        </div>
                                        @endforeach
                                    @endif
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('activities::partials.corporategovpolicy_revision', ['revisions' => $revisions])
                            </div>
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.activities.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
