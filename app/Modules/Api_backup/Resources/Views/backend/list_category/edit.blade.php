...
<section class="content-header">
    <h1>{{ trans('api::backend.edit_category') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('api::backend.home') }}</a></li>
        <li><a href="{{ route('admin.api.list-category.index') }}">{{ trans('api::backend.category') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.api.list-category.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.api.list-category.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('api::backend.back') }}</a>
