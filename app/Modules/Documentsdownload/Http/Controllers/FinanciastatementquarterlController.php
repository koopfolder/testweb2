...
class FinanciastatementquarterlController extends Controller
{
    public function getIndex()
    {
        $items = Documents::Data(['status'=>['publish','draft'],'document_type'=>'financial_statement_quarter']);
        return view('documentsdownload::financial_statement_quarter.index', compact('items'));
    }

    public function getCreate()
    {
        return view('documentsdownload::financial_statement_quarter.create');
    }

    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        $data['document_type'] = 'financial_statement_quarter';
        ...
        return redirect()->route('admin.documents-download.financial-statement-quarter.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        return view('documentsdownload::financial_statement_quarter.edit', compact('data'));
    }
