...
class AnnualreportController extends Controller
{
    ...
    {
        $items = Documents::Data(['status'=>['publish','draft'],'document_type'=>'annual_report']);
        //dd($items);
        return view('documentsdownload::annualreport.index', compact('items'));
    }

    public function getCreate()
    {
        return view('documentsdownload::annualreport.create');
    }
    ...
    public function postCreate(CreateRequest $request)
    {
        ...
        return redirect()->route('admin.documents-download.annual-report.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        //dd($data);
        return view('documentsdownload::annualreport.edit', compact('data'));
    }
