...
<section class="content-header">
    <h1>{{ trans('documentsdownload::backend.add_company_certification_of_association') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.documents-download.company-certification-of-association.create'), 'files' => true]) }}
