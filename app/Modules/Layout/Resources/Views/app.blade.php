...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <script src="{{ asset('adminlte/plugins/ckeditor/build-config.js') }}"></script>-->

<!--  <script src="https://cdn.tiny.cloud/1/x3fwuxrzavqs20dj9haspeczdq5vih45u88r0m4x9k8cupdp/tinymce/5/tinymce.min.js"></script> -->
<script src="{{ asset('adminlte/bower_components/tinymce/tinymce.min.js') }}"></script>
...
<script>
	 ...
	 document_base_url : "{{ env('APP_URL','https://resourcecenter.thaihealth.or.th') }}/",
     ...
     toolbar: "insertfile undo redo | styleselect fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media forecolor backcolor | quicklink h2 h3 blockquote",
  ...
  var editor_config_video = {
     path_absolute : "{{ url('/') }}/",
	 relative_urls : false,
	 remove_script_host : false,
	 document_base_url : "{{ env('APP_URL','https://resourcecenter.thaihealth.or.th') }}/",
     selector: "textarea.ckeditor_video",
     plugins: [
       "media code",
     ],
     toolbar: "media",
   ...
   tinymce.init(editor_config_video);
