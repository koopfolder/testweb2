	...
	<section class="sidebar">
		...
		<div class="input-group">
	  	...
	  	<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview {{ $request->segment(2) == 'thaihealth-watch' ? 'active' : '' }}">
				<a href="#">
					<i class="fa fa-newspaper-o"></i>
			  	...
			  	<ul class="treeview-menu">
				  	<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'setting' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth_watch_setting.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.setting_thaihealth_watch') }}</a>
					</li>

					<!--<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == '' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.thaihealth-watch') }}</a>
					</li>-->

					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'form-generator' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.form-generator.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.form-generator') }}</a>
					</li>
					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'users'  ?  'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.users.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.register') }}</a>
					</li>	
					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'panel-discussion' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.panel-discussion.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.panel_discussion') }}</a>
					</li>
					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'health-trends' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.health-trends.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.health_trends') }}</a>
					</li>

					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'points-to-watch-article' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.points-to-watch-article.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.points_to_watch_article') }}</a>
					</li>
					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'points-to-watch-video' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.points-to-watch-video.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.points_to_watch_video') }}</a>
					</li>
					<li class="{{ $request->segment(2) == 'thaihealth-watch' && $request->segment(3) == 'points-to-watch-gallery' ? 'active' : '' }}">
						<a href="{{ route('admin.thaihealth-watch.points-to-watch-gallery.index') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.points_to_watch_gallery') }}</a>
					</li>	
...
<!-- 
			...
			<li class="treeview {{ $request->segment(2) == 'report' ? 'active' : '' }}">
				<a href="#">
			  	...
			  	<ul class="treeview-menu">
				  	<li class="{{ $request->segment(2) == 'report' && $request->segment(3) == 'login' ? 'active' : '' }}">
						<a href="{{ route('report.login') }}"><i class="fa fa-circle-o"></i>{{ Lang::get('layout::admin.request_login') }}</a>
					</li>
					...
					<li class="{{ $request->segment(2) == 'report' && ($request->segment(3) == 'api' || $request->segment(4) == 'create' || $request->segment(4) == 'edit') ? 'active' : '' }}">
					<a href="{{ route('DonwLoadExcelReport') }}" target="_blank">
					<i class="fa fa-circle-o"></i>Api & WebView
					</a>						
					</li>				
			  	</ul>
			</li>
			...
			<li>
				<a href="https://sso.thaihealth.or.th/authorize?response_type=code&client_id=THRC&redirect_uri=https://persona.thaihealth.or.th/ai/dashboard">
				<!--		
				<a href="https://persona.thaihealth.or.th/ai/dashboard">
				-->	
					<i class="fa fa-newspaper-o"></i>
					<span>จัดการ AI</span>
			  	</a>
