<tr data-entry-id="{{ $children->id }}">
    ...
    <td>
        <a href="{{ route('admin.news.categories.edit', $children->id) }}" class="btn btn-primary"><i class="fa fa-gear"></i> Edit</a>
...
<tr data-entry-id="{{ $item->id }}">
    ...
    <td>
        <a href="{{ route('admin.news.categories.edit', $item->id) }}" class="btn btn-primary"><i class="fa fa-gear"></i> Edit</a>
