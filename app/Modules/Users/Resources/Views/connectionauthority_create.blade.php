...
<section class="content-header">
    <h1>{{ trans('users::backend.connectionauthority_add') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.connectionauthority.create'), 'files' => true]) }}
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-body">
                    <div class="form-group">
                        <label for="ClientId">{{ trans('users::backend.client_id') }} <span style="color:red;">*</span></label>
                        {{ Form::text('client_id', $gen_client_id, ['class' => 'form-control', 'readonly']) }}
                    </div>
                    <div class="form-group">
                        <label for="ClientCompanyName">{{ trans('users::backend.client_company_name') }} <span style="color:red;">*</span></label>
                        {{ Form::text('client_company_name', old('client_company_name'), ['class' => 'form-control']) }}
                    </div>
                    <!-- <div class="form-group">
