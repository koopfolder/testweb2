...
<section class="content-header">
    <h1>{{ trans('exhibition::backend.edit_traveling_exhibition') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.exhibition.traveling.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('exhibition::partials.traveling_exhibition.revision', ['revisions' => $revisions])
                            </div>
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.exhibition.traveling.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
