...
class PermanentController extends Controller
{
    public function getIndex()
    {
        ...
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'permanent_exhibition']);
        //dd($items);
        return view('exhibition::permanent_exhibition.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'permanent_exhibition']);
        return view('exhibition::permanent_exhibition.index-iframe', compact('items'));
    }

    public function getCreate()
    {
        return view('exhibition::permanent_exhibition.create');
    }
    ...
    public function postCreate(CreateArticleRequest $request)
    {
        ...
        $data['page_layout'] = 'permanent_exhibition';
        ...
        return redirect()->route('admin.exhibition.permanent.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        //dd($data,$revisions);
        return view('exhibition::permanent_exhibition.edit', compact('data','revisions'));
    }
