...
class BorrowedController extends Controller
{
    ...
    {
        //dd("borrowedController");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'exhibition_borrowed']);
        //dd($items);
        return view('exhibition::exhibition_borrowed.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'exhibition_borrowed']);
        return view('exhibition::exhibition_borrowed.index-iframe', compact('items'));
    }

    public function getCreate()
    {
        return view('exhibition::exhibition_borrowed.create');
    }
    ...
    public function postCreate(CreateArticleRequest $request)
    {
        ...
        $data['page_layout'] = 'exhibition_borrowed';
        ...
        return redirect()->route('admin.exhibition.borrowed.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        //dd($data,$revisions);
        return view('exhibition::exhibition_borrowed.edit', compact('data','revisions'));
    }
