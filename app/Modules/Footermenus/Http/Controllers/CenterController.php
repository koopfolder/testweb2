...
class CenterController extends Controller
{
    public function getIndex(Request $request)
    {
        ...
        $frontend = Menu::where('parent_id', 0)->where('position','footer-center')->orderBy('order', 'ASC')->get();
    ...
    public function getCreate(Request $request)
    {
        ...
        $menus       = Menu::where('parent_id', 0)->where('position','footer-center')->orderBy('order', 'ASC')->get();
    ...
    public function postCreate(CreateRequest $request)
    {
        ...
        return redirect()->route('admin.footermenus.center.index')
                            ->with('status', 'success')
