...
class ThaihealthWatchPointsToWatchVideoController extends Controller
{
    
    public function getIndex()
    {
        //dd("News");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'points_to_watch_video']);
        //dd($items);
        return view('article::backend.points-to-watch-video.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'points_to_watch_video']);
    ...
    public function getCreate()
    {
        ...
        return view('article::backend.points-to-watch-video.create',compact('tags','years'));
    }
    ...
    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        //dd($data);
        $data['page_layout'] = 'points_to_watch_video';
        ...
        return redirect()->route('admin.thaihealth-watch.points-to-watch-video.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        $years = ThrcHelpers::getYearForBackend();
        //dd($data,$revisions);
        return view('article::backend.points-to-watch-video.edit', compact('data','revisions','tags','tags_select','years'));
    }
