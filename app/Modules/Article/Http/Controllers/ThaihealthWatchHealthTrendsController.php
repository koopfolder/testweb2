...
class ThaihealthWatchHealthTrendsController extends Controller
{
    public function getIndex()
    {
        //dd("health_trends");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'health_trends']);
        //dd($items);
        return view('article::backend.thaihealth-watch-health-trends.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'health_trends']);
    ...
    public function getCreate()
    {
        ...
        return view('article::backend.thaihealth-watch-health-trends.create',compact('tags'));
    }
    ...
    public function postCreate(CreateRequest $request)
    {
        ...
        $data['page_layout'] = 'health_trends';
        ...
        self::postLogs(['event'=>'เพิ่มข้อมูลหัวข้อ "'.$data['title'].'"','module_id'=>'43']);
        return redirect()->route('admin.thaihealth-watch.health-trends.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        //dd($data,$revisions);
        return view('article::backend.thaihealth-watch-health-trends.edit', compact('data','revisions','tags','tags_select'));
    }
    ...
    public function postEdit(EditRequest $request, $id)
    {
        ...
        self::postLogs(['event'=>'แก้ไขข้อมูลหัวข้อ "'.$data['title'].'"','module_id'=>'43']);
        return redirect()->route('admin.thaihealth-watch.health-trends.index')
                            ->with('status', 'success')
    ...
    public static function getDataThaihealthWatch($params)
    {
        ...
        if (Cache::has('data_thaihealth_watch_page_'.$page)){
            ...
            $article = Article::FrontList(['page_layout'=>'health_trends','page'=>$page]);
