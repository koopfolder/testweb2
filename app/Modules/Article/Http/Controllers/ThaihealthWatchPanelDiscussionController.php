...
class ThaihealthWatchPanelDiscussionController extends Controller
{
    
    public function getIndex()
    {
        //dd("News");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'panel_discussion']);
        //dd($items);
        return view('article::backend.thaihealth-watch-panel-discussion.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'panel_discussion']);
    ...
    public function getCreate()
    {
        ...
        return view('article::backend.thaihealth-watch-panel-discussion.create',compact('tags','years'));
    }
    ...
    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        //dd($data);
        $data['page_layout'] = 'panel_discussion';
        ...
        return redirect()->route('admin.thaihealth-watch.panel-discussion.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        $years = ThrcHelpers::getYearForBackend();
        //dd($data,$revisions);
        return view('article::backend.thaihealth-watch-panel-discussion.edit', compact('data','revisions','tags','tags_select','years'));
    }
