...
class ThaihealthWatchPointsToWatchGalleryController extends Controller
{
    
    public function getIndex()
    {
        //dd("News");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'points_to_watch_gallery']);
        //dd($items);
        return view('article::backend.points-to-watch-gallery.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'points_to_watch_gallery']);
    ...
    public function getCreate()
    {
        ...
        return view('article::backend.points-to-watch-gallery.create',compact('tags','years'));
    }
    ...
    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        //dd($data);
        $data['page_layout'] = 'points_to_watch_gallery';
        ...
        return redirect()->route('admin.thaihealth-watch.points-to-watch-gallery.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        $years = ThrcHelpers::getYearForBackend();
        //dd($data,$revisions);
        return view('article::backend.points-to-watch-gallery.edit', compact('data','revisions','tags','tags_select','years'));
    }
