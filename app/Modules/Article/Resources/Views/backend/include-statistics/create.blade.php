...
<section class="content-header">
    <h1>{{ trans('article::backend.add_include-statistics') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.include-statistics.create'), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.include-statistics.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
