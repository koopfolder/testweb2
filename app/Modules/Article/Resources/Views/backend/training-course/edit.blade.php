...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_training-course') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.article.index') }}">{{ trans('article::backend.training-course') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.training-course.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
