...
<section class="content-header">
    <h1>{{ trans('article::backend.add_training-course') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.training-course.create'), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.training-course.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
