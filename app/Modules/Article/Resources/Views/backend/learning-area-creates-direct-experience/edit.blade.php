...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_learning-area-creates-direct-experience') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.learning-area-creates-direct-experience.edit', $data->id), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.learning-area-creates-direct-experience.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.learning-area-creates-direct-experience.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
    ...
    function del_document(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.learning-area-creates-direct-experience.ajaxdeletedocument") }}',
                type: "POST",
                dataType: 'json',
                data: {_token:jQuery('meta[name="csrf-token"]').attr('content'),id:media_id},
                success:function(response){
