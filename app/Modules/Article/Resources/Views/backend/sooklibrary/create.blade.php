...
<section class="content-header">
    <h1>{{ trans('article::backend.add_sook-library') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i>{{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.sook-library.index') }}">{{ trans('article::backend.sook-library') }}</a></li>
        <li class="active">{{ trans('article::backend.add') }}</li>
    </ol>
</section>
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.sook-library.create'), 'files' => true]) }}
