...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_points-to-watch-gallery') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.thaihealth-watch.points-to-watch-gallery.edit', $data->id), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.thaihealth-watch.points-to-watch-gallery.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
