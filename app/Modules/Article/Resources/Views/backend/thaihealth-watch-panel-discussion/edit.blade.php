...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_panel-discussion') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.thaihealth-watch.panel-discussion.index') }}">{{ trans('article::backend.panel-discussion') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.thaihealth-watch.panel-discussion.edit', $data->id), 'files' => true]) }}
                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.thaihealth-watch.panel-discussion.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('article::backend.back') }}</a>
        ...
        <div class="col-md-3">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>{{ trans('article::backend.year') }} </label>
                        {!! Form::select('year',$years,$data->year, ['class' => 'form-control']) !!}
                    </div>                      
                    <div class="form-group">
