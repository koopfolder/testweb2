...
class ThaiHealthWatchUsers extends Model implements HasMediaConversions
{
    ...
    public function scopeData($query,$params)
    {
        ...
        // }
        $query->select('id','name','email','phone','created_at','agency','created_by','updated_by','status');
    ...
    public function scopeDataReport($query,$params)
    {
        //dd($params);
        $lang = $this->getLang();
        // if($lang === 'th'){
        ...
        //     $query->select('year','description_en AS description','created_at','created_by','updated_by');
        // }
        $query->select('name','agency','email','phone','created_at');
