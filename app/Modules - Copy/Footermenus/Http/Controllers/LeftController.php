...
class LeftController extends Controller
{
    ...
    {
        $frontend = Menu::where('parent_id', 0)->where('position','footer-left')->orderBy('order', 'ASC')->get();
    ...
    public function getCreate(Request $request)
    {
        ...
        $menus       = Menu::where('parent_id', 0)->where('position','footer-left')->orderBy('order', 'ASC')->get();
    ...
    public function postCreate(CreateRequest $request)
    {
        ...
        return redirect()->route('admin.footermenus.left.index')
                            ->with('status', 'success')
