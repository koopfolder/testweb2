...
<section class="content-header">
    <h1>{{ trans('roles::backend.add_group') }}</h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('roles::backend.add_group') }}</li>
    </ol>
</section>

<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.roles.create')]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group  col-md-12">
                                        ...
                                        @foreach($abilities as $ability)
                                                <div><input type="checkbox" name="abilities[]" value="{{ $ability }}"> {{ $ability }}</div>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {{ Form::select('status', ['publish' =>trans('roles::backend.publish'), 'draft' =>trans('roles::backend.draft')], old('status'), ['class' => 'form-control']) }}
                    </div>
