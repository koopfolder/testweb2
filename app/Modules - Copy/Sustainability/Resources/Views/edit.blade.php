...
<section class="content-header">
    <h1>{{ trans('article::backend.edit_manager') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('article::backend.home') }}</a></li>
        <li><a href="{{ route('admin.banner.index') }}">{{ trans('article::backend.manager') }}</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_description">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::radio('featured', '1', ($data->featured == '1' ? true:false)) }}{{ trans('article::backend.yes') }}
                                    {{ Form::radio('featured', '2', ($data->featured == '2' ? true:false)) }}{{ trans('article::backend.no') }}
                                </div>
                            </div>
