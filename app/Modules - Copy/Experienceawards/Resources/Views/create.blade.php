...
<section class="content-header">
    <h1>{{ trans('experienceawards::backend.add_experienceawards') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i>{{ trans('sustainability::backend.home') }}</a></li>
        <li><a href="{{ route('admin.history.index') }}">{{ trans('experienceawards::backend.experienceawards') }}</a></li>
        <li class="active">{{ trans('sustainability::backend.add') }}</li>
    </ol>
</section>
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.experienceawards.create'), 'files' => true]) }}
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('order','',['class' => 'form-control']); !!}
                    </div>
                </div>
            </div>
        </div>
