        ...
        try {
            ...
            {  
                ...
                if(isset($task->id)){
                    ...
                    //$media = ListMedia::select('UploadFileID')->where('UploadFileID','=','62aa217b-435d-eb11-80ec-00155d09b41f')->limit($task->page_size)->get();
    ...
    public function getUpdateApi(){
        ...
        foreach ($data as $key => $value) {
            ...
            if(!isset($new_data->id)){
                ...
                DB::table('list_article_api_backup_15_7_2021')->insert(['article_id'=>$value->article_id, 
                                                                        'title'=>$value->title,
