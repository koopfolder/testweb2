...
class Sex extends Model implements HasMediaConversions
{
    use HasMediaTrait;
    protected $table = 'sex';
    ...
    public function scopeData($query,$params)
    {
        ...
        // }
        $query->select('id','name','created_at','created_by','updated_by','status');
    ...
    public function scopeDataHealth($query,$params)
    {
        ...
        //     $query->select('year','description_en AS description','created_at','created_by','updated_by');
        // }
            $query->select('id','title','slug','description','created_at','created_by','updated_by','status','category_id');
        return $query->whereIn('status',$params['status'])->where('page_layout','=',$params['page_layout'])->with('createdBy','updatedBy','category')
            ->orderBy('created_at','DESC')
            //->toSql();
            ->get();
    }
    ...
    public function scopeDetail($query,$params){
        $lang = $this->getLang();
        $query->select('id','title','description','hit','created_at','updated_at','status','meta_title','meta_keywords','meta_description','page_layout','dol_url','dol_json_data','category_id');
