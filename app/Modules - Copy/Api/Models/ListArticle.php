...
class ListArticle extends Model implements HasMediaConversions
{
    ...
    public function scopeFrontListRelated($query,$params){
        ...
        //dd($params);
        //$query->select('id');
        $query->select('list_article.article_id AS id','list_article.title','list_article.description','list_article.hit','list_article.json_data','list_article.created_at','list_article.updated_at','list_article.template','list_article.article_type AS data_type','list_article.slug');
        $sql_like_tags = '';
