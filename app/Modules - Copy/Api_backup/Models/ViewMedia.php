...
class ViewMedia extends Model
{
    ...
    public function scopeData2($query,$params)
    {
        ...
        $query->select('id','title','recommend','articles_research','include_statistics','notable_books','interesting_issues','featured','json_data','created_at','created_by','updated_by','status','issues_id');
