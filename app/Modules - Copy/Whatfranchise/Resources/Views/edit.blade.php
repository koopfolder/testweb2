...
<section class="content-header">
    <h1>{{ trans('whatfranchise::backend.edit_whatfranchise') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('whatfranchise::backend.home') }}</a></li>
        <li><a href="{{ route('admin.banner.index') }}">{{ trans('whatfranchise::backend.whatfranchise') }}</a></li>
        <li class="active">{{ trans('whatfranchise::backend.edit') }}</li>
    </ol>
</section>

<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.whatfranchise.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab_revisions" data-toggle="tab">{{ trans('whatfranchise::backend.revisions') }}</a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_revisions">
                                @include('whatfranchise::partials.revision', ['revisions' => $revisions])
                            </div>    
