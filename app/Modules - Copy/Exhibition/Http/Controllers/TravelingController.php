...
class TravelingController extends Controller
{
    public function getIndex()
    {
        ...
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'traveling_exhibition']);
        //dd($items);
        return view('exhibition::traveling_exhibition.index', compact('items'));
    }

    public function getIndexiframe()
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'traveling_exhibition']);
        return view('exhibition::traveling_exhibition.index-iframe', compact('items'));
    }

    public function getCreate()
    {
        return view('exhibition::traveling_exhibition.create');
    }
    ...
    public function postCreate(CreateArticleRequest $request)
    {
        ...
        $data['page_layout'] = 'traveling_exhibition';
        ...
        return redirect()->route('admin.exhibition.traveling.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        //dd($data,$revisions);
        return view('exhibition::traveling_exhibition.edit', compact('data','revisions'));
    }
