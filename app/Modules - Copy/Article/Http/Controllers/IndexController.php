...
class IndexController extends Controller
{
    ...
    {
        //dd("News");
        $items = Article::Data(['status'=>['publish','draft'],'page_layout'=>'news_event']);
        //dd($items);
    ...
    {
        $items = Article::Data(['status'=>['publish'],'page_layout'=>'news_event']);
    ...
    public function getEdit($id)
    {
        ...
        //dd($data,$revisions);
        return view('article::edit', compact('data','revisions','tags','tags_select'));
    }
