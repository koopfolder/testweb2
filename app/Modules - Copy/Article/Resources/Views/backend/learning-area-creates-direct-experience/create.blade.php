...
<section class="content-header">
    <h1>{{ trans('article::backend.add_learning-area-creates-direct-experience') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.learning-area-creates-direct-experience.create'), 'files' => true]) }}
