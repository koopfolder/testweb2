...
<section class="content-header">
    <h1>{{ trans('franchise::backend.edit_franchise') }}</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('franchise::backend.home') }}</a></li>
        <li><a href="{{ route('admin.franchise.index') }}">{{ trans('franchise::backend.edit_franchise') }}</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.franchise.edit', $data->id), 'files' => true,'id'=>'form_main']) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li ><a href="#tab_attachments" data-toggle="tab">{{ trans('franchise::backend.attachments') }}</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_description">
                                <div class="form-group">
                                    ...
                                    {{ Form::number('juristic_person_registration_number',$data->juristic_person_registration_number ?? old('juristic_person_registration_number'),['class'=>'form-control','maxlength'=>'10']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.brand_name') }} <span style="color:red">*</span></label>
                                    {{ Form::text('brand_name',$data->brand_name ?? old('brand_name'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.company_name') }}<span style="color:red">*</span></label>
                                    {{ Form::text('company_name',$data->company_name ?? old('company_name'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.franchise_type') }}</label>
                                    {{ Form::text('franchise_type',$data->franchise_type ?? old('franchise_type'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::number('number_of_branches',$data->number_of_branches ?? old('number_of_branches'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.lowest_investment_budget') }}</label>
                                    {{ Form::number('lowest_investment_budget',$data->lowest_investment_budget ?? old('lowest_investment_budget'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.highest_investment_budget') }}</label>
                                    {{ Form::number('highest_investment_budget',$data->highest_investment_budget ?? old('highest_investment_budget'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.franchise_fee') }}</label>
                                    {{ Form::text('franchise_fee',$data->franchise_fee ?? old('franchise_fee'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.royalty_fee') }}</label>
                                    {{ Form::text('royalty_fee',$data->royalty_fee ?? old('royalty_fee'),['class'=>'form-control']) }}
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_contact">
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.contacts') }}</label>
                                    {{ Form::text('contact_name',$data->contact_name ?? old('contact_name'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.phone') }}</label>
                                    {{ Form::text('phone',$data->phone ?? old('phone'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.mobile') }}</label>
                                    {{ Form::text('mobile',$data->mobile ?? old('mobile'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.fax') }}</label>
                                    {{ Form::text('fax',$data->fax ?? old('fax'),['class'=>'form-control','maxlength'=>'20']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.email') }}</label>
                                    {{ Form::email('email',$data->email ?? old('email'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.website') }}</label>
                                    {{ Form::text('website',$data->website ?? old('website'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.line') }}</label>
                                    {{ Form::text('line',$data->line ?? old('line'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.facebook') }}</label>
                                    {{ Form::text('facebook',$data->facebook ?? old('facebook'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.youtube') }}</label>
                                    {{ Form::text('youtube',$data->youtube ?? old('youtube'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.instagram') }}</label>
                                    {{ Form::text('instagram',$data->instagram ?? old('instagram'),['class'=>'form-control','maxlength'=>'50']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.contacts_address') }}</label>
                                    {{ Form::text('contact_address',$data->contact_address ?? old('contact_address'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.subdistrict') }}<span style="color:red">*</span></label>
                                    {{ Form::text('contact_subdistrict',$data->contact_subdistrict ?? old('contact_subdistrict'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.district') }}<span style="color:red">*</span></label>
                                    {{ Form::text('contact_district',$data->contact_district ?? old('contact_district'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.provice') }}<span style="color:red">*</span></label>
                                    {{ Form::text('contact_province',$data->contact_province ?? old('contact_province'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.zipcode') }}<span style="color:red">*</span></label>
                                    {{ Form::text('contact_zipcode',$data->contact_zipcode ?? old('contact_zipcode'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                  ...
                                  <input id="find" type="button" value="{{ trans('franchise::backend.find') }}" class="btn btn-default" />
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::text('lat',$data->contact_latitude ?? old('lat'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">{{ trans('franchise::backend.longitude') }}</label>
                                    {{ Form::text('lng',$data->contact_longitude ?? old('lng'),['class'=>'form-control']) }}
                                </div>
                                <div class="form-group">
                                    ...
                                    @if($data->branch !='')
                                        @foreach($data->branch AS $key=>$value)
                                            @php
                                                //dd($value['address']);
                                            @endphp
                                    <div class="form-group location" id="lo_{{ $key+1 }}">
                                    <span>ที่อยู่ {{ $value['address']." ".$value['subdistrict']." ".$value['district']." ".$value['province']." ".$value['zipcode'] }}</span>
                                    {{ Form::hidden('location_address[]',$value['address']) }}
                                    {{ Form::hidden('location_subdistrict[]',$value['subdistrict']) }}
                                    {{ Form::hidden('location_district[]',$value['district']) }}
                                    {{ Form::hidden('location_province[]',$value['province']) }}
                                    {{ Form::hidden('location_zipcode[]',$value['zipcode']) }}
                                    {{ Form::hidden('location_lat[]',$value['latitude']) }}
                                    {{ Form::hidden('location_lng[]',$value['longitude']) }}
                                    <button type="button" class="btn btn-danger" onclick="JavaScript:del_location('{{ $key+1 }}');" style="float: right;">ลบ</button>
                                    <button type="button" class="btn btn-primary" onclick="JavaScript:edit_location('{{ $key+1 }}');" style="float: right;margin-right: 10px;">แก้ไขที่อยู่ตามแผนที่</button>
                                    </div>
                                        @endforeach
                                    @endif
                                </div>
                            ...
                            <div class="tab-pane" id="tab_cover_image">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div><img src="{{ asset($data->getMedia('logo_desktop')->first()->getUrl()) }}" width="250"></div>
                                    @endif
                                ...
                                <div id="zone_document">
                                    ...
                                    @if($data->attachments->count() >0)
                                        ...
                                        <div class="form-group document col-md-12" id="dm_{{ $key+1 }}" data-id="{{ $value->id }}">
                                            <label for="InputName">{{ trans("franchise::backend.attachments") }}</label>
                                            <div class="areaImage">
                                                <div><a href="{{ asset($value->file_path) }}" download="{{ $value->title }}.{{ $value->file_type }}">{{ $value->title }}</a></div>
                                                <div><img class="del_document" onclick="JavaScript:del_document({{ $key+1 }});" src="{{ asset("dbdfranchise/images/if_plus_add_minus.png") }}" title="Delete attachments" id="delete_document" alt="delete_document"></div>
                                            </div>
                                        </div>
                                        @endforeach
                                    @endif
                            ...
                            <div class="tab-pane" id="tab_seo">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('meta_description',$data->meta_description ?? old('meta_description'),['class'=>'form-control']) }}
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_revisions">
                                @include('franchise::partials.revision', ['revisions' => $revisions])
                            </div>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id',$category, old('category_id',$data->category_id), ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group">
                        @php
...
<script type="text/javascript">
    ...
    function del_gallery(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.franchise.ajaxdeletegallery") }}',
                type: "POST",
                dataType: 'json',
    ...
    function del_document(id){
        ...
        if(media_id !=''){
            jQuery.ajax({
                url: '{{ route("admin.franchise.ajaxdeletedocument") }}',
                type: "POST",
                dataType: 'json',
                data: {_token:jQuery('meta[name="csrf-token"]').attr('content'),id:media_id},
                success:function(response){
