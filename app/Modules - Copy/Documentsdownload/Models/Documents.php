...
class Documents extends Model implements HasMediaConversions
{
    use HasMediaTrait;
    ...
    {   
        $query->select('id','title','file_name','file_path','file_type');
        return $query->where('model_id',$params['model_id'])
    ...
    {   
        $lang = \App::getLocale();
        if($lang === 'th'){
            $query->select('id','title_th AS title','file_name_th','file_name_en','file_path_th','file_path_en','created_at','created_by','updated_by','status');
        }else{
            $query->select('id','title_en AS title','file_name_th','file_name_en','file_path_th','file_path_en','created_at','created_by','updated_by','status');
        }
