...
<section class="content-header">
	<h1>{{ trans('documentsdownload::backend.company_regulation') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('documentsdownload::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.documents-download.company-regulation.index') }}">{{ trans('documentsdownload::backend.company_regulation') }}</a></li>
	</ol>
</section>
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.documents-download.company-regulation.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.documents-download.company-regulation.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									@endif
									<a href="{{ route('admin.documents-download.company-regulation.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('documentsdownload::backend.edit') }}
									</a>
									<a href="{{ route('admin.documents-download.company-regulation.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
