...
<section class="content-header">
    <h1>{{ trans('documentsdownload::backend.edit_shareholders_repor') }}</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.documents-download.shareholders-report.edit', $data->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <a href="{{ route('admin.documents-download.shareholders-report.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> {{ trans('documentsdownload::backend.back') }}</a>
