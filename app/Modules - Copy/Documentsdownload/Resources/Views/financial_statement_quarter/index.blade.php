...
<section class="content-header">
	<h1>{{ trans('documentsdownload::backend.financial_statement_quarter') }}</h1>
	<ol class="breadcrumb">
    	<li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('documentsdownload::backend.home') }}</a></li>
    	<li><a href="{{ route('admin.documents-download.financial-statement-quarter.index') }}">{{ trans('documentsdownload::backend.financial_statement_quarter') }}</a></li>
	</ol>
</section>
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        	<div class="box">
				{{ Form::open(['url' => route('admin.documents-download.financial-statement-quarter.deleteAll')]) }}
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							<a href="{{ route('admin.documents-download.financial-statement-quarter.create') }}" class="btn btn-primary">
						...
						<tbody>
							...
							<tr data-entry-id="{{ $item->id }}">
								...
								<td>
									...
									@endif
									<a href="{{ route('admin.documents-download.financial-statement-quarter.edit', $item->id) }}" class="btn btn-primary">
										<i class="fa fa-gear"></i> {{ trans('documentsdownload::backend.edit') }}
									</a>
									<a href="{{ route('admin.documents-download.financial-statement-quarter.delete', $item->id) }}" data-toggle="confirmation" data-title="Are you sure ?" class="btn btn-danger">
