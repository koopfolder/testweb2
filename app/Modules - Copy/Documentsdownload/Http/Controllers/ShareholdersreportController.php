...
class ShareholdersreportController extends Controller
{
    public function getIndex()
    {
        $items = Documents::Data(['status'=>['publish','draft'],'document_type'=>'shareholders_report']);
        return view('documentsdownload::shareholders_report.index', compact('items'));
    }

    public function getCreate()
    {
        return view('documentsdownload::shareholders_report.create');
    }

    public function postCreate(CreateRequest $request)
    {
        $data = $request->all();
        $data['document_type'] = 'shareholders_report';
        ...
        return redirect()->route('admin.documents-download.shareholders-report.index')
                            ->with('status', 'success')
    ...
    public function getEdit($id)
    {
        ...
        return view('documentsdownload::shareholders_report.edit', compact('data'));
    }
