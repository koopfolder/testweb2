...
<section class="content-header">
    <h1>Review Revision News</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ route('admin.revision.index') }}">Review Revision News</a></li>
...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.news.revision.review', $page->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a href="{{ route('admin.news.revision.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
