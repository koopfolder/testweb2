...
<section class="content">
    <div class="row">
        {{ Form::open(['url' => route('admin.restaurant.edit', $restaurant->id), 'files' => true]) }}
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('name', $restaurant->name ?? old('name'), ['class' => 'form-control']) }}
                                </div>
                                <div class="form-group">
                                    <label for="InputName">Open Hours <span style="color:red;">*</span></label>
                                    {{ Form::text('open_hours', $restaurant->open_hours ?? old('open_hours'), ['class' => 'form-control']) }}
                                </div>                                
                                <div class="form-group">
                                    <label for="InputEmailAddress">Description</label>
                                    <textarea name="description" class="form-control ckeditor">{!! $restaurant->description ?? old('description') !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tab_revision">
                                @include('restaurant::partials.revision', ['revisions' => $revisions])
                            </div>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['publish' => 'Publish',  'draft' => 'Draft'], $restaurant->status ?? old('status'), ['class' => 'form-control']) !!}
                    </div>
                </div>
            </div>
        </div>
